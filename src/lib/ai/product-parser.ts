...
async function parseWithGemini(
  ...
  const responseSchema = {
    ...
    properties: {
      ...
      // variant_group dùng key động (0,1,2...) → khai báo đơn giản không có properties.
      // Parse variant_group từ raw text response sau khi nhận được.
      variant_group: { type: "object" },
    },
